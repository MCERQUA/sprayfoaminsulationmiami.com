      ...
      <main>
        <article className="bg-cream pt-32 pb-16 md:pt-40">
          <div className="container-tight max-w-3xl">
            <FadeIn>
              <Link href="/blog" className="inline-flex items-center gap-1.5 text-sm font-heading font-semibold text-clay hover:gap-2.5 transition-all mb-8">
                <ArrowLeft className="h-4 w-4" />
                All articles
              </Link>

              <div className="flex flex-wrap items-center gap-3 text-xs text-mocha mb-4">
                <span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-clay/10 text-clay rounded-md font-heading font-semibold">
              ...
              <h1 className="font-heading font-extrabold text-espresso text-3xl md:text-4xl lg:text-5xl leading-[1.1] tracking-tight">
                {post.title}
              </h1>
              ...
              <div className="mt-12 p-7 rounded-3xl bg-espresso text-cream">
                <p className="font-heading font-extrabold text-cream text-xl">Ready to insulate your Miami property?</p>
                <p className="text-cream/75 mt-2 text-sm">Get a free estimate — same-day response and transparent pricing from Miami's insulation experts.</p>
                <div className="mt-5 flex flex-col sm:flex-row gap-3">
                  <Link href="/quote" className="btn-primary">Get My Free Estimate</Link>
