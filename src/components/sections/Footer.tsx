        ...
        <div className="container-wide py-10 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <p className="font-heading font-bold text-2xl text-cream">
              Ready to insulate your Miami property?
            </p>
            <p className="text-cream/70 mt-1">
              Free estimates. Same-day response. Certified crews serving South Florida since 2008.
            </p>
          </div>
          <div className="flex flex-col sm:flex-row gap-3">
            <a href={SITE.phoneHref} className="btn-secondary !bg-white/10 !border-white/20 !text-cream hover:!bg-white/20 hover:!text-white">
      ...
      <div className="container-wide py-14 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
        <div className="col-span-2 lg:col-span-2">
          ...
          <p className="text-cream/70 text-sm leading-relaxed max-w-sm">
            Miami&apos;s trusted spray foam insulation experts. Protecting homes and businesses from
            Florida&apos;s heat since 2008.
          </p>
          <div className="mt-5 inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10">
            ...
            <span className="text-xs font-semibold text-cream/90">Licensed, bonded &amp; insured · SPFA certified</span>
          </div>
        </div>

        <div>
          <p className="font-heading font-bold text-cream mb-4 text-sm uppercase tracking-wider">
            Services
          </p>
        ...
        <div>
          ...
          <ul className="space-y-2.5">
            ...
            <li>
              <Link href="/coverage" className="text-cream/70 hover:text-gold text-sm transition-colors">
                All service areas
              </Link>
            </li>
            <li>
              <Link href="/blog" className="text-cream/70 hover:text-gold text-sm transition-colors">
                Blog & Insights
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="space-y-3.5 text-sm">
            <li>
              <a href={SITE.phoneHref} className="flex items-start gap-2.5 text-cream/80 hover:text-gold transition-colors">
                <Phone className="h-4 w-4 mt-0.5 text-gold flex-shrink-0" />
                <span>
                  <span className="block font-semibold text-cream">{SITE.phone}</span>
                  <span className="text-xs text-cream/60">Miami, FL</span>
                </span>
              </a>
            </li>
            <li>
              <a href={`mailto:${SITE.email}`} className="flex items-start gap-2.5 text-cream/80 hover:text-gold transition-colors">
            ...
            <li className="flex items-start gap-2.5 text-cream/80">
              ...
              <span>
                {SITE.hours}<br />
                <span className="text-xs text-cream/60">Same-day response guaranteed</span>
              </span>
            </li>
          </ul>
        </div>
